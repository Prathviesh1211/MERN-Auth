...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center
        ...
        <p className='mb-8 max-w-md'>Let's start with quick product tour and we will have 
            you up and running in no time
        </p>
        <button className='rounded-full px-8 py-2.5 
            border border-gray-500 hover:bg-gray-100 transition-all'>Get Started</button>
    </div>
  )
}
